...
namespace mobo
{
    ...
    */
    ...
    struct pnt {
        ...
        pnt<T, SIZE>& operator=(const pnt<T, SIZE>& iv) { int i = SIZE; while(i--) v[i] = iv[i]; return *this; }
        pnt<T, SIZE>& operator=(const vec<T, SIZE>& iv) { int i = SIZE-1; v[i] = 1.0; while(i--) v[i] = iv[i]; return *this; }
